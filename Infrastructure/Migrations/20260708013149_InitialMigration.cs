        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MainOfficePhoneNumber = table.Column<string>(type: "text", nullable: false),
                    MainOfficeEmail = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AffiliateWorkingDays", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AffiliateWorkingDays_Affiliates_AffiliateId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Employees_Affiliates_AffiliateId",
                        column: x => x.AffiliateId,
                        principalTable: "Affiliates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", maxLength: 32, nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductCategories_Affiliates_AffiliateId",
                        column: x => x.AffiliateId,
                        principalTable: "Affiliates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerCoordinates = table.Column<string>(type: "text", nullable: true),
                    ProductPrice = table.Column<decimal>(type: "numeric(10,2)", nullable: false),
                    DeliveryPrice = table.Column<decimal>(type: "numeric(10,2)", nullable: false),
                    ...
                    OtherReceiverName = table.Column<string>(type: "text", nullable: true),
                    OtherReceiverPhone = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AffiliateBrakes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AffiliateBrakes_AffiliateWorkingDays_WorkingDayId",
                        column: x => x.WorkingDayId,
                        principalTable: "AffiliateWorkingDays",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    AffiliateRating = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ratings_Affiliates_AffiliateId",
                        column: x => x.AffiliateId,
                        principalTable: "Affiliates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderAdditionals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderAdditionals_Additionals_AdditionalId",
                        column: x => x.AdditionalId,
                        principalTable: "Additionals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderAdditionals_OrderProducts_OrderProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AffiliateBrakes_WorkingDayId",
                table: "AffiliateBrakes",
                column: "WorkingDayId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AffiliateWorkingDays_AffiliateId",
                table: "AffiliateWorkingDays",
                column: "AffiliateId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderAdditionals_AdditionalId",
                table: "OrderAdditionals",
                column: "AdditionalId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderAdditionals_OrderProductId",
                table: "OrderAdditionals",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductCategories_AffiliateId",
